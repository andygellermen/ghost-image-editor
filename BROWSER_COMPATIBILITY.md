...
Das Projekt verwendet **Manifest V3** mit einem `background.service_worker` und browser-spezifischen Manifesten unter `src/manifests/`.
Der Build erzeugt getrennte Artefakte je Browser (`dist/chrome`, `dist/firefox`, `dist/opera`, `dist/safari`).
